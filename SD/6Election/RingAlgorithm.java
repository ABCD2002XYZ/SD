...
public class RingAlgorithm { public static void main(String[] args) { 
...
for (i = 0; i < processes.length; i++) processes[i] = new Process();
...
processes[j + 1] = temp;
  ...
  System.out.println("[" + processes[i].index + "] " + processes[i].id);
   ...
   case 1: System.out.println("Enter the index of the process initiating the election: "); 
   ...
   default: System.out.println("Invalid response.");
      ...
      processes[nextIndex].hasSentMessage = true; tempIndex = nextIndex; 
      } 
